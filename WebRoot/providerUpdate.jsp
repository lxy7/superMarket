...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="/SuperMarket/provider?action=update" onsubmit="return checkit();">
		<div class="content">
		<font color="red"></font>
<input name="flag" value="doAdd" type="hidden">
			...
			<tbody>
				<tr>
					...
					<td><input name="proName" id="textfield2" value="${pro.name }" class="text" type="text"> <font color="red">*</font></td>

				</tr>
			<tr>
					<td class="field">供应商描述：</td>
					<td><textarea name="proDesc" id="textarea" cols="45" rows="5">${pro.detail }</textarea></td>
				</tr>
				<tr>
					<td class="field">供应商联系：</td>

					<td><input name="contact" id="textfield2" value="${pro.peoson }" class="text" type="text"></td>
				</tr>
				<tr>
					<td class="field">供应商电话：</td>
					<td><input name="phone" id="textfield2" value="${pro.phone }" class="text" type="text"></td>
				</tr>
